            ...
            <div class="panel-ctrls">
                <div class="right">
                    <div class="btn-group">
                        ...
                        <a target="_blank" class="btn btn-primary c-btn-pdf" href="<?php echo Yii::app()->createUrl('keuangan/data/pdfdonation') ?>">
                            PDF
                        </a>
                    </div>
                </div> 
                            ...
                            array(
                                ...
                                "buttons" => array(
                                    "view" => array(
                                        'label' => '',
                                        "imageUrl" => "",
                                        'options' => array('class' => 'glyphicon glyphicon-search c-simple-update', 'data-url' => 'Yii::app()->createUrl("keuangan/data/updateDonation", array("id"=>$data->id))', 'data-modal-id' => 'update-donation-modal', 'target' => "_blank"),
...
//                                                        ),
                                    "delete" => array(
                                        ...
                                        'url' => 'Yii::app()->createUrl("keuangan/data/deletedonation", array("id"=>$data->id))'
                                        )
                                    )
),
array(
    ...
    <tbody>
        <tr>
            ...
            <td width="20%" style="text-align:right;" class="c-total-finance-month">
                <?php echo "Rp ".number_format($page_donation, 2, ",", "."); ?>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php
                $this->renderPartial('_addDonationDialogForm', array('model_add' => $model_add, 'action' => 'adddonation'));
                ?>
            </div>
