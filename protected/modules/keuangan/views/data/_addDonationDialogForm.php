...
if($action == 'updateGoods'){
    $action_url = Yii::app()->createUrl('keuangan/data/updatedonation/', array('id'=>$model_add->id));
}
else{
    $action_url = Yii::app()->createUrl('keuangan/data/adddonation/', array());
}
...
<div class="form-group">
    ...
    <div style="float:left;" class="input-group date form_date col-md-6" data-date="" data-date-format="dd MM yyyy">
        ...
        ?>"
        name="Donasi[tanggal]" id="Donasi_tanggal">
