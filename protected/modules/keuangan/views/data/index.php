<div class="static-content"> 
    <div id="wrap" class="mainview-animation animated ng-scope"><div id="page-heading" class="ng-scope">
            ...
            ?>
            <h1>Data Keuangan<?php // echo $this->uniqueId . '/' . $this->action->id;             ?></h1>
        </div>
                    ...
                    <panel panel-class="panel-primary" heading="Button Variants" class="ng-isolate-scope">
                        <div class="panel panel-bottom">
                            <div class="panel-heading">
                                <h2 class="ng-binding">Data Keuangan</h2>
                            </div>
                            <div class="panel-body c-combined-form">
                                ...
                                <?php echo $this->renderPartial('_Donasi', array('model_donation' => $model_donation, 'model_add' => $model_donation_add, 'year_sequence_donation' => $year_sequence_donation, 'last_year_donation'=>$last_year_donation, 'last_month_donation'=>$last_month_donation, 'page_donation' => $page_donation)); ?>
                                <?php echo $this->renderPartial('_Pengeluaran', array('model_expenditure' => $model_expenditure, 'model_add' => $model_expenditure_add, 'hide' => 1, 'year_sequence_expenditure'=>$year_sequence_expenditure, 'last_year_expenditure'=>$last_year_expenditure, 'last_month_expenditure'=>$last_month_expenditure)); ?>
                                <!--</form>-->
                            </div>                            
                        </div>
                    </panel>
