...
<div class="static-content">
    <div id="wrap" class="mainview-animation animated ng-scope"><div id="page-heading" class="ng-scope">
        ...
        ?>
            <h1>Data Ustadz<?php // echo $this->uniqueId . '/' . $this->action->id;        ?></h1>
        </div>
                    ...
                    <panel panel-class="panel-primary" heading="Button Variants" class="ng-isolate-scope">
                        <div class="panel panel-indigo panel-single">
                            <div class="panel-heading">
                                <h2 class="ng-binding">Manajemen Data Ustadz</h2>
                                <?php
                                ...
                                <div class="panel-ctrls">
                                    <div class="right">
                                        <div class="btn-group">
                                            <a class="btn-default btn" href="<?php echo Yii::app()->createUrl('ustadz/data/create') ?>">
                            ...
                            <div class="panel-body">
                                <div class="clear"></div>
                                <p>
                                    Berikut ini merupakan tabel yang berisikan data Ustadz. 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <?php
                                        echo CHtml::dropDownList('pondok', 'empty', Pondokan::getPondokanList(), array('empty' => 'Asrama', 'class' => 'form-control c-santri-filter', 'data-url' => Yii::app()->createUrl('ustadz/data/')));
                                        ?>
                                    </div>
                                    <div class="btn-group col-sm-3">
                                        <?php
                                        echo CHtml::button('Semua', array('class' => 'btn btn-default c-gender-filter', 'data-id' => '', 'data-url' => Yii::app()->createUrl('ustadz/data/')));
                                        echo CHtml::button('Putra', array('class' => 'btn btn-default c-gender-filter', 'data-id' => '1', 'data-url' => Yii::app()->createUrl('ustadz/data/')));
                                        echo CHtml::button('Putri', array('class' => 'btn btn-default c-gender-filter', 'data-id' => '2', 'data-url' => Yii::app()->createUrl('ustadz/data/')));
...
//                                    echo CHtml::beginForm('#', 'POST', array("id" => "search-santri"));
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Cari Ustadz" name="search-santri" id="search-santri">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">Form Registrasi Ustadz</h4>
                                            </div>
