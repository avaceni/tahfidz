                ...
                <div class="content-list-box">
                    ...
                    <div class="box-list">
                        <div class="box-list-wrap">
                            <div class="image-box"><img src="<?php echo Yii::app()->baseUrl?>/images/resource/masjid_madinah.jpg"></div>
                            <div class="box-list-detail">
                                <a href="<?php echo Yii::app()->createUrl("front/profil/detailmasjid");?>" class="title">Masjid Sa'bah Madinah</a>
                                <p class="content">
                                ...
                                <div class="button-box">
                                    <a href="<?php echo Yii::app()->createUrl("front/profil/detailmasjid")?>" class="button more orange">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="box-list">
                        <div class="box-list-wrap">
                        <div class="image-box"><img src="<?php echo Yii::app()->baseUrl?>/images/resource/news.jpg"></div>
                            <div class="box-list-detail">
                                <a href="<?php echo Yii::app()->createUrl("front/profil/detailmasjid")?>" class="title">Masjid Sultan Omar Ali Saifuddin</a>
                                <p class="content">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                    tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                    quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
