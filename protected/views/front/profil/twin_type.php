                    ...
                    foreach ($content as $ormas) {
                        ...
                        <div class="box-list">
                            <div class="box-list-wrap">
                                <div class="image-box"><img src="<?php echo Yii::app()->baseUrl . $ormas->image_cover ?>"></div>
                                <div class="box-list-detail">
                                    <a href="<?php echo Yii::app()->createUrl($base_url, array('id' => $ormas->id)); ?>" class="title"><?php echo $ormas->title ?></a>
                                    <p class="content">
                                        <?php echo $ormas->description ?>
                                    </p>
                                    <div class="button-box">
                                        <a href="<?php echo Yii::app()->createUrl($base_url, array('id' => $ormas->id)) ?>" class="button more orange">Selengkapnya</a>
                                    </div>
                                </div>
                            </div>
                        </div>
