...
/**
 * This is the model class for table "santri_prestasi".
 *
 * The followings are the available columns in table 'santri_prestasi':
 * @property string $id
 ...
 */
class SantriPrestasi extends CActiveRecord
{
	/**
	...
	public function search()
	{
		...
		$criteria->compare('juara',$this->juara,true);
	 ...
	 * @return SantriPrestasi the static model class
	 */
